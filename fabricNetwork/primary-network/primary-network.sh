...
#
#
# This script includes functionality to bring down the network, 
# create a channel,
# and to bring it up with CAs and CouchDBs
#
...
# Default container CLI, check for docker-compose or docker compose
...
# Versions of fabric known not to work with the primary network
...
function checkPrereqs() {
  ...
  ## Check for peer binaries and configuration files
...
function networkDown() {
  ...
  # Don't remove the generated artifacts but, the ledgers are always removed
